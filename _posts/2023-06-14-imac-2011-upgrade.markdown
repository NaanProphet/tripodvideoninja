...
Apple Logic Pro X 10.5[^13] requires Mojave, and at the time I was collaborating on some projects created in Logic 10.5. To use them on the iMac, I need to swap the GPU with one that supports Metal and then install the Mojave unofficially.[^19]
